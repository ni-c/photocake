<div class="exposureprograms view">
<h2><?php  echo __('Exposureprogram'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($exposureprogram['Exposureprogram']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($exposureprogram['Exposureprogram']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($exposureprogram['Exposureprogram']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($exposureprogram['Exposureprogram']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Exposureprogram'), array('action' => 'edit', $exposureprogram['Exposureprogram']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Exposureprogram'), array('action' => 'delete', $exposureprogram['Exposureprogram']['id']), null, __('Are you sure you want to delete # %s?', $exposureprogram['Exposureprogram']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($exposureprogram['Photo'])): ?>
	...
	<?php
		$i = 0;
		foreach ($exposureprogram['Photo'] as $photo): ?>
		<tr>
