<div class="meteringmodes view">
<h2><?php  echo __('Meteringmode'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($meteringmode['Meteringmode']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($meteringmode['Meteringmode']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($meteringmode['Meteringmode']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($meteringmode['Meteringmode']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Meteringmode'), array('action' => 'edit', $meteringmode['Meteringmode']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Meteringmode'), array('action' => 'delete', $meteringmode['Meteringmode']['id']), null, __('Are you sure you want to delete # %s?', $meteringmode['Meteringmode']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($meteringmode['Photo'])): ?>
	...
	<?php
		$i = 0;
		foreach ($meteringmode['Photo'] as $photo): ?>
		<tr>
