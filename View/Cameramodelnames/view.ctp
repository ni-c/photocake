<div class="cameramodelnames view">
<h2><?php  echo __('Cameramodelname'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($cameramodelname['Cameramodelname']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($cameramodelname['Cameramodelname']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Created'); ?></dt>
		<dd>
			<?php echo h($cameramodelname['Cameramodelname']['created']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Modified'); ?></dt>
		<dd>
			<?php echo h($cameramodelname['Cameramodelname']['modified']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Cameramodelname'), array('action' => 'edit', $cameramodelname['Cameramodelname']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Cameramodelname'), array('action' => 'delete', $cameramodelname['Cameramodelname']['id']), null, __('Are you sure you want to delete # %s?', $cameramodelname['Cameramodelname']['id'])); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($cameramodelname['Photo'])): ?>
	...
	<?php
		$i = 0;
		foreach ($cameramodelname['Photo'] as $photo): ?>
		<tr>
