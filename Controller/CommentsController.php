...
class CommentsController extends AppController {
    ...
    public function add() {
        ...
        if ($this->request->is('post')) {
			...
			if ($api_key!='') {
				if ($this->Defensio->check($api_key, $this->request->data['Comment']['comment'], $this->request->data['Comment']['name'], $this->request->data['Comment']['email'], $this->request->data['Comment']['website'])) {
			...
			print_r($this->request->data['Comment']);
